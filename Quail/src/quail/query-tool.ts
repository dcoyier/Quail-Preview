...
export function createQuailQueryToolDefinition(
	...
	return {
		...
		label: "quail",
		description:
			"Execute Quail qualitative-analysis DSL against processed datasets. Use this for dataset metadata, grouping, retrieval, counts, distributions, and evidence lookup. Pass dataset names in datasets and DSL statements in code; do not write $ blocks as assistant text.",
